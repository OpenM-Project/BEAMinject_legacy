...
THIS IS NOT MEANT TO BE USED SEPERATELY!
========================================
You can run it via CLI to use silently,
but it is experimental and lacks features
such as setting custom chunksize and not
launching Minecraft by default.

No support will be provided for any errors
that are generated by running this script
via CLI.
"""
__version__ = "0.1.1"
